module github.com/davidmontoyago/pulumi-cloud-run-service

replace github.com/davidmontoyago/pulumi-cloud-run-service => ./
...
require (
	...
	github.com/pulumi/pulumi-gcp/sdk/v6 v6.65.0 // indirect
